...
import { MacGlobalKeyLookup } from "./keymap";
import Path from "node:path";
import fs from "node:fs";
import type { IMacConfig } from "../../types/IMacConfig";
...
const buildPath = "../../../build/MacKeyServer";
const runtimePath = "../../../runtime/MacKeyServer";
