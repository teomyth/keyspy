import type { IMacConfig } from "./IMacConfig";
import type { IWindowsConfig } from "./IWindowsConfig";
import type { IX11Config } from "./IX11Config";
...
export type IConfig = {
  ...
  disposeDelay?: number;
  /** Default application name to display in permission requests (can be overridden by platform-specific configs) */
  appName?: string;
};
